...
export function GET() {
  const body = [
    ...
    `> ${siteDescription}`,
    "",
    "TokenRank is a public leaderboard for aggregate AI coding token usage. It is useful for understanding which AI coding tools and models people are using, without exposing prompts, source code, chats, filenames, or file contents.",
    "",
    "## Core Pages",
    "",
    `- [Leaderboard](${absoluteUrl("/")}) - Public ranking by total tokens, estimated cost, and individual AI coding tools.`,
